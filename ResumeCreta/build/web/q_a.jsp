...
<html>
 <head>
  <title>Reset Password - RESUME CRETA</title>
  <meta charset="utf-8">
 ...
 <body onoffline="lost()" ononline="load()" id="body">
  ...
  <br><br><br><br>
  <form action="../check_qa" method="POST">
   <div class="container">
    <h3><b>Reset Password</b></h3>
    <p>Reset password by profile's secret answer/key :</p>
    <div class="row-12">
     <label for="mobile">Registered Mobile Number</label>
     <input type="tel" name="mobile" value="<%= P.getMobile() %>" readonly>
     <label for="forgetque"><b>Security Question</b></label>
     <input type="text" name="forgetque" value="<%= P.getForgetque() %>" readonly>
     <label for="forgetans"><b>Security Answer</b></label>
     ...
     <span class="w3-right">Be carefully, security answer is case-sensitive.</span>
     <input type="submit" value="Reset Password">
     <br><br><br>
     <a class="nav-link" href="http://www.resumecreta.com:8084/ResumeCreta/index/" style="cursor:pointer;width:50px;"><i class="fa fa-arrow-left"></i>&nbsp;Back</a>
    </div>
   </div> 
  </form>
  <br><br><br><br><br><br>

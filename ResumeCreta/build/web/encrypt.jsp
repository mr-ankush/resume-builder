...
P = pd.searchprofiledatabyusername(r);
%>
<%
if(ProfileDAO.checkurl(r))
{
%>
<!DOCTYPE html>
<html>
...
<html>
 ...
 <body style="background: #c3d8f1;" onoffline="lost()" ononline="load()" id="body">
  <div class="container w3-center">
   <img src="images/expired.gif" alt="Link revoked" style="width:40%;height:auto; margin-top:5%" draggable="false">
   <div class="centeredimginvalid" style="cursor: pointer;">
    <div class="w3-container w3-card-4 w3-round-xlarge w3-text-black" style="background:white">
     <span onmouseover="change3()" onmouseout="change4()"><a href="" style="text-decoration:none;"><h2 id="hide2"><i class="fa fa-exclamation-triangle w3-text-red"></i>&nbsp;Link expired</h2></a></span>
    </div>
   </div>
   <script>
    function change3(){
    ...
    function change4(){
     document.getElementById("hide2").innerHTML = "<i class='fa fa-exclamation-triangle w3-text-red'></i>&nbsp;URL revoked";
    }
     </script>
  </div>
  <style>

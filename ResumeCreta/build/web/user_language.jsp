   ...
   <div class="container">
    ...
    <div class="row-12">
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="lk_1" id="lk_1" placeholder="Not compulsary to fill all" value="<%= P.getLk_1() %>" autocomplete="off" spellcheck="true" onfocus="selectText1()" onkeyup="hide1()"> 
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="lk_2" id="lk_2" placeholder="Not compulsary to fill all" value="<%= P.getLk_2() %>" autocomplete="off" spellcheck="true" onfocus="selectText2(); hide2();" onkeyup="hide2()">
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="lk_3" id="lk_3" placeholder="Not compulsary to fill all" value="<%= P.getLk_3() %>" autocomplete="off" spellcheck="true" onfocus="selectText3(); hide3();" onkeyup="hide3()">
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="lk_4" id="lk_4" placeholder="Not compulsary to fill all" value="<%= P.getLk_4() %>" autocomplete="off" spellcheck="true" onfocus="selectText4()" onkeyup="hide4()">
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="lk_5" id="lk_5" placeholder="Not compulsary to fill all" value="<%= P.getLk_5() %>" autocomplete="off" spellcheck="true" onfocus="selectText5()" onkeyup="hide5()">
    ...
    {
      var input1 = document.getElementById("lk_1");
      input1.focus();
      input1.select();
    }
    function selectText2()
    {
      var input2 = document.getElementById("lk_2");
      input2.focus();
      input2.select();
    }
    function selectText3() 
    {
      var input3 = document.getElementById("lk_3");
      input3.focus();
      input3.select();
    }
    function selectText4() 
    {
      var input4 = document.getElementById("lk_4");
      input4.focus();
      input4.select();
    }
    function selectText5() 
    {
      var input5 = document.getElementById("lk_5");
      input5.focus();
      input5.select();
    }
    var Input1 = document.getElementById("lk_1").value;
    if(Input1=="")
    {
    ...
    var Input2 = document.getElementById("lk_2").value;
    if(Input2=="")
    {
    ...
    var Input3 = document.getElementById("lk_3").value;
    if(Input3=="")
    {
    ...
    var Input4 = document.getElementById("lk_4").value;
    if(Input4=="")
    {
    ...
    var Input5 = document.getElementById("lk_5").value;
    if(Input5=="")
    {

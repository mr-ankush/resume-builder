...
<html>
 ...
 <body onoffline="lost()" ononline="load()" id="body">
   ...
   <div class="container">
    ...
    <div class="row-12">
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="ih_1" id="ih_1" placeholder="Not compulsary to fill all" value="<%= P.getIh_1() %>" autocomplete="off" spellcheck="true" onfocus="selectText1()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
	<label for="ih_2">Interest / Hobby 2</label>
      ...
      <div class="col-75">
       <input type="text" name="ih_2" id="ih_2" placeholder="Not compulsary to fill all" value="<%= P.getIh_2() %>" autocomplete="off" spellcheck="true" onfocus="selectText2()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ih_3" id="ih_3" placeholder="Not compulsary to fill all" value="<%= P.getIh_3() %>" autocomplete="off" spellcheck="true" onfocus="selectText3()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ih_4" id="ih_4" placeholder="Not compulsary to fill all" value="<%= P.getIh_4() %>" autocomplete="off" spellcheck="true" onfocus="selectText4()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ih_5" id="ih_5" placeholder="Not compulsary to fill all" value="<%= P.getIh_5() %>" autocomplete="off" spellcheck="true" onfocus="selectText5()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ih_6" id="ih_6" placeholder="Not compulsary to fill all" value="<%= P.getIh_6() %>" autocomplete="off" spellcheck="true" onfocus="selectText6()">
      </div>
     </div>
  ...
  {
    var input1 = document.getElementById("ih_1");
    input1.focus();
    input1.select();
  }
  function selectText2()
  {
    var input2 = document.getElementById("ih_2");
    input2.focus();
    input2.select();
  }
  function selectText3() 
  {
    var input3 = document.getElementById("ih_3");
    input3.focus();
    input3.select();
  }
  function selectText4() 
  {
    var input4 = document.getElementById("ih_4");
    input4.focus();
    input4.select();
  }
  function selectText5() 
  {
    var input5 = document.getElementById("ih_5");
    input5.focus();
    input5.select();
  }
  function selectText6() 
  {
    var input6 = document.getElementById("ih_6");
    input6.focus();
    input6.select();
  }
  </script>

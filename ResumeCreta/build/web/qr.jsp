...
<html>
 <head>
  <title>QR Generate - RESUME CRETA</title>
  <meta charset="utf-8">
 ...
 <body onoffline="lost()" ononline="load()" id="body">
  ...
  %>
  <br><br><br><br><br>
  <form action="../../qr_activate" method="POST">
   <input type="hidden" name="qr_id" value="<%= P.getMobile() %>">
   <div class="container">
    <h3><b>Generate QR Code</b></h3>
    <p>Generate your's profile QR-Code & use in CV/Resume/Portfolio :</p>
  ...
  <form action="../../qr_activate" method="POST">
   ...
   <div class="container">
    ...
    <div class="row-12 w3-margin-bottom" style="background-color:white">
     <div>
      <input type="submit" value="Update QR Code">
      <br><br><br><br>
      <span class="w3-right">Previous QR-Code also work as well as New QR-Code (Previously Qr-Code works until your registered mobile number not updated)</span>
     </div>
    </div>
   </div>
  </form>

 ...
 <body onoffline="lost()" ononline="load()" id="body">
  ...
  <form action="../../hide" method="POST">
   ...
   <div class="container">
	...
	<option value="Show" disabled>Show&nbsp;[PUBLIC]</option>
        <option value="Hide" selected>Hide&nbsp;&nbsp;[PRIVATE]</option>
       </select>
      </div>
     </div>
    </div>
    <div class="row-12">
     <div class="row">
      <div class="col-25">
       <label for="v_msg">Reason to hide profile</label>
      </div>
      <div class="col-75">
       <input list="v_msg" name="v_msg" placeholder="Tell me the reason why are you hiding your resume" spellcheck="true" required autofocus="on" autocomplete="off">
       <datalist id="v_msg" style="display:none">
        <option value="">Custom Fill</option>
        <option value="I haven't finished my studies yet">I haven't finished my studies yet</option>
        <option value="I'm not ready for job">I'm not ready for job</option>
        <option value="Doing internship now">Doing internship now</option>
        <option value="I'm busy with other work">I'm busy with other work</option>
        <option value="I don't need a job right now">I don't need a job right now</option>
        <option value="I have already given my resume to companies">I have already given my resume to companies</option>
        <option value="I got a job">I got a job</option>
        <option value="Started my own business">Started my own business</option>
        <option value="I'm in home town">I'm in home town</option>
        <option value="Some personal issues">Some personal issues</option>
       </datalist>
       <span>This message will be visible to people searching for you, fill it with awareness.</span>
      </div>
     </div>
     <input type="submit" value="Hide Resume Profile">
     <br><br><br>

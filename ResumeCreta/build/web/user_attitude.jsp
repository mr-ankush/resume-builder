...
<html>
 ...
 <body onoffline="lost()" ononline="load()" id="body">
   ...
   <div class="container">
    ...
    <div class="row-12">
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="ba_1" id="ba_1" placeholder="Not compulsary to fill all" value="<%= P.getBa_1() %>" autocomplete="off" spellcheck="true" onfocus="selectText1()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ba_2" id="ba_2" placeholder="Not compulsary to fill all" value="<%= P.getBa_2() %>" autocomplete="off" spellcheck="true" onfocus="selectText2()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ba_3" id="ba_3" placeholder="Not compulsary to fill all" value="<%= P.getBa_3() %>" autocomplete="off" spellcheck="true" onfocus="selectText3()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ba_4" id="ba_4" placeholder="Not compulsary to fill all" value="<%= P.getBa_4() %>" autocomplete="off" spellcheck="true" onfocus="selectText4()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ba_5" id="ba_5" placeholder="Not compulsary to fill all" value="<%= P.getBa_5() %>" autocomplete="off" spellcheck="true" onfocus="selectText5()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ba_6" id="ba_6" placeholder="Not compulsary to fill all" value="<%= P.getBa_6() %>" autocomplete="off" spellcheck="true" onfocus="selectText6()">
      </div>
     </div>
  ...
  {
    var input1 = document.getElementById("ba_1");
    input1.focus();
    input1.select();
  }
  function selectText2()
  {
    var input2 = document.getElementById("ba_2");
    input2.focus();
    input2.select();
  }
  function selectText3() 
  {
    var input3 = document.getElementById("ba_3");
    input3.focus();
    input3.select();
  }
  function selectText4() 
  {
    var input4 = document.getElementById("ba_4");
    input4.focus();
    input4.select();
  }
  function selectText5() 
  {
    var input5 = document.getElementById("ba_5");
    input5.focus();
    input5.select();
  }
  function selectText6() 
  {
    var input6 = document.getElementById("ba_6");
    input6.focus();
    input6.select();
  }
  </script>

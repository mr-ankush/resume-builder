...
<html>
 <head>
  <title>Link Generate - RESUME CRETA</title>
  <meta charset="utf-8">
 ...
 <body onoffline="lost()" ononline="load()" id="body">
  ...
  %>
  <br><br><br><br><br>
  <form action="../../link_activate" method="POST">
   <input type="hidden" name="mobile" value="<%= P.getMobile() %>">
   <div class="container">
    <h3><b>Generate Custom Link</b></h3>
    <p>Custom link is not visible to anyone, untill you are not share to anyone:</p>
    <div class="row-12 w3-margin-bottom" style="background-color:white">
     <div>
      <input type="submit" value="Generate Encrypted URL">
     </div>
    </div>
   </div>
  </form>
  ...
  %>
  <br><br><br><br><br>
  <form action="../../link_deactivate" method="POST">
   <input type="hidden" name="mobile" value="<%= P.getMobile() %>">
   <div class="container">
    <h3><b>Shared Link Status</b></h3>
    <p>All collaborator on this link can view this file:</p>
    <div class="row-12 w3-margin-bottom" style="background-color:white">
     <div>
      <input type="text" id="link" name="link" readonly value="http://www.resumecreta.com:8084/ResumeCreta/encrypt?r=<%= P.getUsername() %>" onclick="urlcopy()" style="font-size:20px;font-weight:bold;">
      <span class="w3-right" id="urlmsg">Click on link</span>
      <script>
       function urlcopy()
       {
           ...
           alert("Copied URL :\n" + copyText.value);
           document.getElementById("urlmsg").innerHTML = "Link copied.";
       }
      </script>
      <input type="submit" value="Deactivate Encrypted URL">
     </div>
    </div>
   </div>
  </form>
  ...
  %>
  <div class="container w3-left" style="background-color:white;width:150px;">
   <b><a class="nav-link" href="../../menu?mobile=<%= P.getMobile() %>" style="cursor:pointer;"><i class="fa fa-arrow-left"></i>&nbsp;Back</a></b>
  </div>

...
<html>
 <head>
  <title>Profile Delete - RESUME CRETA</title>
  <meta charset="utf-8">
  ...
  <div id="id01" class="modal">
   ...
   <form class="modal-content" action="../../delete" method="POST">
    ...
    <div class="container">
     ...
     <p>Are you sure you want to delete your Resume Creta account?</p>
     <input class="reason" list="v_msg" name="v_msg" placeholder="Share your experience / feedback" spellcheck="true" required autofocus="on" autocomplete="off">
       <datalist id="v_msg" style="display:none">
        <option value="">Custom Fill</option>
        <option value="I already have an account">I already have an account</option>
        <option value="I don't need it regularly">I don't need it regularly</option>
        <option value="Looking for jobs on other platforms">Looking for jobs on other platforms</option>
        <option value="This website is slow">This website is slow</option>
        <option value="Website interface is not good">Website interface is not good</option>
        <option value="Lack of features">Lack of features</option>
        <option value="I'm afraid to share details">I'm afraid to share details</option>
        <option value="I'm disturbed by calls from companies">I'm disturbed by calls from companies</option>
        <option value="Started my own business">Started my own business</option>
        <option value="I don't need a job">I don't need a job</option>
        <option value="I got a job">I got a job</option>
        <option value="I use offline process">I use offline process</option>
       </datalist>
     <div class="clearfix">
      <a href="../../menu?mobile=<%= P.getMobile() %>"><button type="button" onclick="document.getElementById('id01').style.display='none'" class="cancelbtn">Cancel</button></a>

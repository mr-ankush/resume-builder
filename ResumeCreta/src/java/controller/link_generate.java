...
public class link_generate extends HttpServlet 
{
    @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        try 
        {
            ...
            String NUMBERS = "AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZZ_01_23_45_67_89_87_65_43_21_0";
            ...
            if(mobile!=null)
            {
                ...
                if(pd.updateusername(P)){
                    ...
                    session.setAttribute("msg",
                            "Custom URL link is ready to visible.<br>"
                                    + "Copy link & send it.");

...
@media screen and (max-width: 300px) {
 ...
 <body onload="checkback(); timeout();" onpageshow="if(event.persisted){checkback();}">
</script>
  <div id="id01" class="modal">
   <form class="modal-content">
    <div class="container">
     <h1>Account Log-Out</h1>
     <p><progress class="w3-bar w3-button" value="0" max="5" min="0" id="countdown"></progress></p>
     <p><b id="leftsec"></b></p>
     <p><%= Msg %></p>
     <div class="clearfix">
      <a href="http://www.resumecreta.com:8084/ResumeCreta/index/"><button type="button" onclick="document.getElementById('id01').style.display='none'" class="cancelbtn">Go to Login Page</button></a>
      <a href="http://www.resumecreta.com:8084/ResumeCreta/"><button type="button" onclick="document.getElementById('id01').style.display='none'" class="deletebtn">Got to Website</button></a>
     </div>
    </div>
   </form>
  </div>

 ...
 <body onoffline="lost()" ononline="load()" id="body">
  ...
  <form action="../../../update_cert_detail" method="POST">
   ...
   <div class="container">
    ...
    <div class="row-12">
     <div class="row" id="certdiv1">
      <div class="col-25">
       <label for="certificate_1">Certificate 1</label>
      </div>
      <div class="col-75">
       <input type="text" name="certificate_1" id="certificate_1" placeholder="Not compulsary to fill all" value="<%= P.getCertificate_1() %>" onfocus="selectText1()" autocomplete="off" spellcheck="true">
      </div>
     </div>
     <div class="row" id="certdiv2">
      ...
      <div class="col-75">
       <input type="text" name="certificate_2" id="certificate_2" placeholder="Not compulsary to fill all" value="<%= P.getCertificate_2() %>" onfocus="selectText2()" autocomplete="off" spellcheck="true">
      </div>
     </div>
     <div class="row" id="certdiv3">
      ...
      <div class="col-75">
       <input type="text" name="certificate_3" id="certificate_3" placeholder="Not compulsary to fill all" value="<%= P.getCertificate_3() %>" onfocus="selectText3()" autocomplete="off" spellcheck="true">
      </div>
     </div>
     <div class="row" id="certdiv4">
      ...
      <div class="col-75">
       <input type="text" name="certificate_4" id="certificate_4" placeholder="Not compulsary to fill all" value="<%= P.getCertificate_4() %>" onfocus="selectText4()" autocomplete="off" spellcheck="true">
      </div>
     </div>
     <div class="row" id="certdiv5">
      ...
      <div class="col-75">
       <input type="text" name="certificate_5" id="certificate_5" placeholder="Not compulsary to fill all" value="<%= P.getCertificate_5() %>" onfocus="selectText5()" autocomplete="off" spellcheck="true">
      </div>
     </div>
     <div class="row" id="certdiv6">
      ...
      <div class="col-75">
       <input type="text" name="certificate_6" id="certificate_6" placeholder="Not compulsary to fill all" value="<%= P.getCertificate_6() %>" onfocus="selectText6()" autocomplete="off" spellcheck="true">
      </div>
     </div>
  ...
  {
    var input1 = document.getElementById("certificate_1");
    input1.focus();
    input1.select();
  }
  function selectText2()
  {
    var input2 = document.getElementById("certificate_2");
    input2.focus();
    input2.select();
  }
  function selectText3() 
  {
    var input3 = document.getElementById("certificate_3");
    input3.focus();
    input3.select();
  }
  function selectText4() 
  {
    var input4 = document.getElementById("certificate_4");
    input4.focus();
    input4.select();
  }
  function selectText5() 
  {
    var input5 = document.getElementById("certificate_5");
    input5.focus();
    input5.select();
  }
  function selectText6() 
  {
    var input6 = document.getElementById("certificate_6");
    input6.focus();
    input6.select();
  }
  </script>

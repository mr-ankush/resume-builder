...
<html>
 ...
 <body onoffline="lost()" ononline="load()" id="body">
  ...
  <form action="../../../updateemail" method="POST">
   ...
   <div class="container">
    <h3><b>Update Email-Id</b></h3>
    <p>This change will appear on your resume & change login setting:</p>
    <div class="row-12">
     <label for="currentemail">Current Email</label>
     <input type="text" id="currentemail" name="currentemail" placeholder="Current Email-Id" required autofocus="on" autocomplete="off">
     <label for="newemail">New Email</label>
     <input type="text" id="newemail" name="newemail" placeholder="New Email-Id" required autofocus="on" autocomplete="off">
     <label for="currentpassword">Password</label>
     <input type="text" id="currentpassword" name="currentpassword" placeholder="Password" pattern="(?=.*\d)(?=.*[A-Z])(?=.*[a-z]).{8,}" title="Password must contain uppercase, lowercase, number/specialchar & min 8 chars." minlenght="8" maxlength="15" required autofocus="on" autocomplete="off">
     <input type="submit" value="Update Email-Id">
     <br><br><br>
  ...
  <form action="../../../updatemobile" method="POST">
   ...
   <div class="container">
    ...
    <h3><b>Update Mobile</b></h3>
    <p>This change will appear on your resume and the login settings will change:</p>
    <div class="row-12">
     <label for="currentmobile">Current Mobile Number</label>
     <input type="text" id="currentmobile" name="currentmobile" placeholder="Current Mobile Number" minlength="10" maxlength="10" pattern="[6-9]{1}[0-9]{9}" required autofocus="on" autocomplete="off">
     <label for="newmobile">New Mobile Number</label>
     <input type="text" id="newmobile" name="newmobile" placeholder="New Mobile Number" minlength="10" maxlength="10" pattern="[6-9]{1}[0-9]{9}" required autofocus="on" autocomplete="off">
     <label for="currentpassword">Password</label>
     <input type="text" id="currentpassword" name="currentpassword" placeholder="Password" pattern="(?=.*\d)(?=.*[A-Z])(?=.*[a-z]).{8,}" title="Password must contain uppercase, lowercase, number/specialchar & min 8 chars." minlenght="8" maxlength="15" required autofocus="on" autocomplete="off">

...
<html>
 <head>
  <title>Profile Edit - RESUME CRETA</title>
  <meta charset="utf-8">
   ...
   <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbar12">
     ...
     <ul class="navbar-nav mx-auto">
         <li class="nav-item"> <a class="nav-link">Hii <%= P.getEmail() %> (<%= P.getIsd() %>)<%= mobile %></a> </li>
     </ul>
     <ul class="navbar-nav">
  ...
  <form action="../../upload" method="POST" enctype="multipart/form-data">
   <div class="container">
    ...
    <div class="row-12">
     ...
     <select name="cv_type" required autocomplete="off" autofocus="on">
     ...
     <select name="cv_theme" required autocomplete="off" autofocus="on">
     ...
     <input list="cv_designation" name="cv_designation" required autocomplete="off" autofocus="on">
   ...
   <div class="container">
    ...
    <div class="row-12">
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" id="firstname" name="firstname" placeholder="First name" required autocomplete="off" autofocus="on" onfocus="selectfirstname()">
       <input type="text" id="lastname" name="lastname" placeholder="Last name" required autocomplete="off" autofocus="on" onfocus="selectlastname()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <select id="f_title" name="f_title" required autocomplete="off" autofocus="on">
        <option value="">Select One</option>
        <option value="Mr.">Mr.</option>
	<option value="Late">Late</option>
       </select>
       <input type="text" id="fname" name="f_name" placeholder="Father name" required autocomplete="off" autofocus="on" onfocus="selectfname()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <select id="m_title" name="m_title" required autocomplete="off" autofocus="on">
        <option value="">Select One</option>
        <option value="Mrs.">Mrs.</option>
	<option value="Late">Late</option>
       </select>
       <input type="text" id="mname" name="m_name" placeholder="Mother name" required autocomplete="off" autofocus="on" onfocus="selectmname()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="date" id="dob" name="dob" required autocomplete="off" autofocus="on">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <select id="gender" name="gender" required autofocus="on" autocomplete="off">
	<option value="">Select One</option>
	...
	<option value="Others">Others</option>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" id="mobile" name="mobile" placeholder="Contact Number" maxlength="10" value="<%= mobile %>" readonly>
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="tel" id="altmobile" name="altmobile" placeholder="Alternate Contact Number" minlength="10" maxlength="10" title="Enter personal contact number." pattern="[6-9]{1}[0-9]{9}" required autofocus="on" autocomplete="off" onfocus="selectaltmobile()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" id="la_city" name="la_city" placeholder="Currently live in city" required autofocus="on" autocomplete=" off" onfocus="selectcity()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" id="la_state" name="la_state" placeholder="Currently live in state" required autofocus="on" autocomplete="off" onfocus="selectstate()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" id="la_country" name="la_country" placeholder="Currently live in country" required autofocus="on" autocomplete="off" onfocus="selectcountry()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" id="nationality" name="nationality" placeholder="Currently live in country" required autofocus="on" autocomplete="off" onfocus="selectnationality()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <textarea id="permanentadd" name="permanentadd" placeholder="Resident address/Home town" style="height:100px" required autofocus="on" autocomplete="off" onfocus="selectadd()"></textarea>
      </div>
     </div>
    </div>
   </div>
   ...
   <div class="container">
    ...
    <div class="row-12">
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="lk_1" placeholder="Not compulsary to fill all" id="lk_1" autocomplete="on" spellcheck="true" onfocus="selectlk1()" onkeyup="hidelk1()"> 
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="lk_2" placeholder="Not compulsary to fill all" id="lk_2" autocomplete="on" spellcheck="true" onfocus="selectlk2()" onkeyup="hidelk2()">
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="lk_3" placeholder="Not compulsary to fill all" id="lk_3" autocomplete="on" spellcheck="true" onfocus="selectlk3()" onkeyup="hidelk3()"> 
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="lk_4" placeholder="Not compulsary to fill all" id="lk_4" autocomplete="on" spellcheck="true" onfocus="selectlk4()" onkeyup="hidelk4()"> 
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="lk_5" placeholder="Not compulsary to fill all" id="lk_5" autocomplete="on" spellcheck="true" onfocus="selectlk5()" onkeyup="hidelk5()"> 
   ...
   <div class="container">
    ...
    <div class="row-12">
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="s_1" placeholder="Not compulsary to fill all" id="s_1" autocomplete="on" spellcheck="true" onfocus="selects1()" onkeyup="hides1()">
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="s_2" placeholder="Not compulsary to fill all" id="s_2" autocomplete="on" spellcheck="true" onfocus="selects2()" onkeyup="hides2()">
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="s_3" placeholder="Not compulsary to fill all" id="s_3" autocomplete="on" spellcheck="true" onfocus="selects3()" onkeyup="hides3()">
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="s_4" placeholder="Not compulsary to fill all" id="s_4" autocomplete="on" spellcheck="true" onfocus="selects4()" onkeyup="hides4()">
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="s_5" placeholder="Not compulsary to fill all" id="s_5" autocomplete="on" spellcheck="true" onfocus="selects5()" onkeyup="hides5()">
     ...
     <div class="row">
      <div class="col-25">
       <label for="s_6">Skill 6</label>
      </div>
      <div class="col-75">
       <input type="text" name="s_6" placeholder="Not compulsary to fill all" id="s_6" autocomplete="on" spellcheck="true" onfocus="selects6()" onkeyup="hides6()">
	...
	<option value="95">95%</option>
     ...
     <div class="row">
      <div class="col-25">
       <label for="s_7">Skill 7</label>
      </div>
      <div class="col-75">
       <input type="text" name="s_7" placeholder="Not compulsary to fill all" id="s_7" autocomplete="on" spellcheck="true" onfocus="selects7()" onkeyup="hides7()">
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="s_8" placeholder="Not compulsary to fill all" id="s_8" autocomplete="on" spellcheck="true" onfocus="selects8()" onkeyup="hides8()">
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="s_9" placeholder="Not compulsary to fill all" id="s_9" autocomplete="on" spellcheck="true" onfocus="selects9()" onkeyup="hides9()">
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="s_10" placeholder="Not compulsary to fill all" id="s_10" autocomplete="on" spellcheck="true" onfocus="selects10()" onkeyup="hides10()">
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="s_11" placeholder="Not compulsary to fill all" id="s_11" autocomplete="on" spellcheck="true" onfocus="selects11()" onkeyup="hides11()">
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="s_12" placeholder="Not compulsary to fill all" id="s_12" autocomplete="on" spellcheck="true" onfocus="selects12()" onkeyup="hides12()">
	...
	<option value="100">100%</option>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="s_13" placeholder="Not compulsary to fill all" id="s_13" autocomplete="on" spellcheck="true" onfocus="selects13()" onkeyup="hides13()">
	...
	<option value="100">100%</option>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="s_14" placeholder="Not compulsary to fill all" id="s_14" autocomplete="on" spellcheck="true" onfocus="selects14()" onkeyup="hides14()">
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="s_15" placeholder="Not compulsary to fill all" id="s_15" autocomplete="on" spellcheck="true" onfocus="selects15()" onkeyup="hides15()">
   ...
   <div class="container">
    ...
    <div class="row-12">
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="ba_1" placeholder="Not compulsary to fill all" id="ba1" spellcheck="true" autocomplete="on" spellcheck="true" onfocus="selectba1()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ba_2" placeholder="Not compulsary to fill all" id="ba2" spellcheck="true" autocomplete="on" spellcheck="true" onfocus="selectba2()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ba_3" placeholder="Not compulsary to fill all" id="ba3" spellcheck="true" autocomplete="on" spellcheck="true" onfocus="selectba3()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ba_4" placeholder="Not compulsary to fill all" id="ba4" spellcheck="true" autocomplete="on" spellcheck="true" onfocus="selectba4()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ba_5" placeholder="Not compulsary to fill all" id="ba5" spellcheck="true" autocomplete="on" spellcheck="true" onfocus="selectba5()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ba_6" placeholder="Not compulsary to fill all" id="ba6" spellcheck="true" autocomplete="on" spellcheck="true" onfocus="selectba6()">
      </div>
     </div>
    </div>
   </div>
   ...
   <div class="container">
    ...
    <div class="row-12">
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="ih_1" placeholder="Not compulsary to fill all" id="ih1" spellcheck="true" autocomplete="on" spellcheck="true" onfocus="selectih1()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
	<label for="ih_2">Interest / Hobby 2</label>
      ...
      <div class="col-75">
       <input type="text" name="ih_2" placeholder="Not compulsary to fill all" id="ih2" spellcheck="true" autocomplete="on" spellcheck="true" onfocus="selectih2()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ih_3" placeholder="Not compulsary to fill all" id="ih3" spellcheck="true" autocomplete="on" spellcheck="true" onfocus="selectih3()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ih_4" placeholder="Not compulsary to fill all" id="ih4" spellcheck="true" autocomplete="on" spellcheck="true" onfocus="selectih4()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ih_5" placeholder="Not compulsary to fill all" id="ih5" spellcheck="true" autocomplete="on" spellcheck="true" onfocus="selectih5()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="ih_6" placeholder="Not compulsary to fill all" id="ih6" spellcheck="true" autocomplete="on" spellcheck="true" onfocus="selectih6()">
      </div>
     </div>
    </div>
   </div>
   ...
   <div class="container">
    ...
    <div class="row-12">
     <div class="row">
      ...
      <div class="col-75">
       <textarea name="objective" id="objective" style="height:200px" required autofocus="on" spellcheck="true" onfocus="selectobj()"></textarea>
      </div>
     </div>
    </div>
   </div>
   ...
   <div class="container">
    ...
    <div class="row-12">
     ...
     <div class="row">
      ...
      <div class="col-75">
          <input list="degree_1" name="degree_1" id="deg1" placeholder="Fill degree carefully" autocomplete="on" spellcheck="true" onfocus="selectdeg1()" onkeyup="hided1();">
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input list="affiliate_1" name="affiliate_1" id="aff1" placeholder="Fill affiliation carefully" autocomplete="on" spellcheck="true" onfocus="selectaff1()" onkeyup="">
	...
	<option value="C.B.S.E.">C.B.S.E.</option>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="institute_1" id="ins1" placeholder="Institute name" autocomplete="on" spellcheck="true" onfocus="selectins1()" onkeyup="">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="score_1" id="sco1" placeholder="eg. 75.53%, 8.30CGPA, etc." autocomplete="on" spellcheck="true" onfocus="selectsco1()" onkeyup="">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="session_1" id="ses1" placeholder="eg. 2014 - 2017 , 2017 - CURRENT, etc." autocomplete="on" spellcheck="true" onfocus="selectses1()" onkeyup="">
      </div>
     </div>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input list="degree_2" name="degree_2" id="deg2" placeholder="Fill degree carefully" autocomplete="on" spellcheck="true" onfocus="selectdeg2()" onkeyup="hided2()">
	...
	<option value="Ph.D. - ">Ph.D. - [DEGREE_NAME]</option>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input list="affiliate_2" name="affiliate_2" id="aff2" placeholder="Fill affiliation carefully" autocomplete="on" spellcheck="true" onfocus="selectaff2()" onkeyup="">
	...
	<option value="C.B.S.E.">C.B.S.E.</option>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="institute_2" id="ins2" placeholder="Institute name" autocomplete="on" spellcheck="true" onfocus="selectins2()" onkeyup="">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="score_2" id="sco2" placeholder="eg. 75.53%, 8.30CGPA, etc." autocomplete="on" spellcheck="true" onfocus="selectsco2()" onkeyup="">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="session_2" id="ses2" placeholder="eg. 2014 - 2017 , 2017 - CURRENT, etc." autocomplete="on" spellcheck="true" onfocus="selectses2()" onkeyup="">
      </div>
     </div>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input list="degree_3" name="degree_3" id="deg3" placeholder="Fill degree carefully" autocomplete="on" spellcheck="true" onfocus="selectdeg3()" onkeyup="hided3()">
	...
	<option value="Ph.D. - ">Ph.D. - [DEGREE_NAME]</option>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input list="affiliate_3" name="affiliate_3" id="aff3" placeholder="Fill affiliation carefully" autocomplete="on" spellcheck="true" onfocus="selectaff3()" onkeyup="">
	...
	<option value="C.B.S.E.">C.B.S.E.</option>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="institute_3" id="ins3" placeholder="Institute name" autocomplete="on" spellcheck="true" onfocus="selectins3()" onkeyup="">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="score_3" id="sco3" placeholder="eg. 75.53%, 8.30CGPA, etc." autocomplete="on" spellcheck="true" onfocus="selectsco3()" onkeyup="">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="session_3" id="ses3" placeholder="eg. 2014 - 2017 , 2017 - CURRENT, etc." autocomplete="on" spellcheck="true" onfocus="selectses3()" onkeyup="">
      </div>
     </div>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input list="degree_4" name="degree_4" id="deg4" placeholder="Fill degree carefully" autocomplete="on" spellcheck="true" onfocus="selectdeg4()" onkeyup="hided4()">
	...
	<option value="Ph.D. - ">Ph.D. - [DEGREE_NAME]</option>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input list="affiliate_4" name="affiliate_4" id="aff4" placeholder="Fill affiliation carefully" autocomplete="on" spellcheck="true" onfocus="selectaff4()" onkeyup="">
	...
	<option value="C.B.S.E.">C.B.S.E.</option>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="institute_4" id="ins4" placeholder="Institute name" autocomplete="on" spellcheck="true" onfocus="selectins4()" onkeyup="">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="score_4" id="sco4" placeholder="eg. 75.53%, 8.30CGPA, etc." autocomplete="on" spellcheck="true" onfocus="selectsco4()" onkeyup="">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="session_4" id="ses4" placeholder="eg. 2014 - 2017 , 2017 - CURRENT, etc." autocomplete="on" spellcheck="true" onfocus="selectses4()" onkeyup="">
      </div>
     </div>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input list="degree_5" name="degree_5" id="deg5" placeholder="Fill degree carefully" autocomplete="on" spellcheck="true" onfocus="selectdeg5()" onkeyup="hided5()">
	...
	<option value="Ph.D. - ">Ph.D. - [DEGREE_NAME]</option>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input list="affiliate_5" name="affiliate_5" id="aff5" placeholder="Fill affiliation carefully" autocomplete="on" spellcheck="true" onfocus="selectaff5()" onkeyup="">
	...
	<option value="C.B.S.E.">C.B.S.E.</option>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="institute_5" id="ins5" placeholder="Institute name" autocomplete="on" spellcheck="true" onfocus="selectins5()" onkeyup="">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="score_5" id="sco5" placeholder="eg. 75.53%, 8.30CGPA, etc." autocomplete="on" spellcheck="true" onfocus="selectsco5()" onkeyup="">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="session_5" id="ses5" placeholder="eg. 2014 - 2017 , 2017 - CURRENT, etc." autocomplete="on" spellcheck="true" onfocus="selectses5()" onkeyup="">
      </div>
     </div>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input list="degree_6" name="degree_6" id="deg6" placeholder="Fill degree carefully" autocomplete="on" spellcheck="true" onfocus="selectdeg6()" onkeyup="hided6()">
	...
	<option value="Ph.D. - ">Ph.D. - [DEGREE_NAME]</option>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input list="affiliate_6" name="affiliate_6" id="aff6" placeholder="Fill affiliation carefully" autocomplete="on" spellcheck="true" onfocus="selectaff6()" onkeyup="">
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="institute_6" id="ins6" placeholder="Institute name" autocomplete="on" spellcheck="true" onfocus="selectins6()" onkeyup="">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="score_6" id="sco6" placeholder="eg. 75.53%, 8.30CGPA, etc." autocomplete="on" spellcheck="true" onfocus="selectsco6()" onkeyup="">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="session_6" id="ses6" placeholder="eg. 2014 - 2017 , 2017 - CURRENT, etc." autocomplete="on" spellcheck="true" onfocus="selectses6()" onkeyup="">
      </div>
     </div>
    </div>
  <script>
  ...
  <div class="container">
    ...
    <div class="row-12">
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="certificate_1" id="certificate_1" placeholder="Not compulsary to fill all" onfocus="selectcert1()" autocomplete="on" spellcheck="true">
      </div>
     </div>
     <div class="row" id="certdiv2">
      ...
      <div class="col-75">
       <input type="text" name="certificate_2" id="certificate_2" placeholder="Not compulsary to fill all" onfocus="selectcert2()" autocomplete="on" spellcheck="true">
      </div>
     </div>
     <div class="row" id="certdiv3">
      ...
      <div class="col-75">
       <input type="text" name="certificate_3" id="certificate_3" placeholder="Not compulsary to fill all" onfocus="selectcert3()" autocomplete="on" spellcheck="true">
      </div>
     </div>
     <div class="row" id="certdiv4">
      ...
      <div class="col-75">
       <input type="text" name="certificate_4" id="certificate_4" placeholder="Not compulsary to fill all" onfocus="selectcert4()" autocomplete="on" spellcheck="true">
      </div>
     </div>
     <div class="row" id="certdiv5">
      ...
      <div class="col-75">
       <input type="text" name="certificate_5" id="certificate_5" placeholder="Not compulsary to fill all" onfocus="selectcert5()" autocomplete="on" spellcheck="true">
      </div>
     </div>
     <div class="row" id="certdiv6">
      ...
      <div class="col-75">
       <input type="text" name="certificate_6" id="certificate_6" placeholder="Not compulsary to fill all" onfocus="selectcert6()" autocomplete="on" spellcheck="true">
      </div>
     </div>
    </div>
   </div> 
   ...
   <div class="container">
    ...
    <div class="row-12">
     <div class="row">
      ...
      <div class="col-75">
       <select name="workexperience" id="workexperience" required autofocus="on" autocomplete="on" onchange="change()">
        <option value="">Select One</option>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="project_1" id="project1" placeholder="Project name" autocomplete="on" onfocus="selectproject1()" onkeyup="hidew1()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="projectdate_1" id="projectdate1" placeholder="Project duration / Time period of project (eg. March 2015 - June 2016)" autocomplete="on" onfocus="selectprojectdate1()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="work_1" id="work1" placeholder="Project description" autocomplete="on" spellcheck="true" onfocus="selectwork1()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="url" name="worklink_1" id="worklink1" placeholder="Paste link of project (if available)" autocomplete="on" onfocus="selectworklink1()">
      </div>
     </div>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="project_2" id="project2" placeholder="Project name" autocomplete="on" onfocus="selectproject2()" onkeyup="hidew2()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="projectdate_2" id="projectdate2" placeholder="Project duration / Time period of project (eg. March 2015 - June 2016)" autocomplete="on" onfocus="selectprojectdate2()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="work_2" id="work2" placeholder="Project description" autocomplete="on" spellcheck="true" onfocus="selectwork2()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="url" name="worklink_2" id="worklink2" placeholder="Paste link of project (if available)" autocomplete="on" onfocus="selectworklink2()">
      </div>
     </div>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="project_3" id="project3" placeholder="Project name" autocomplete="on" onfocus="selectproject3()" onkeyup="hidew3()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="projectdate_3" id="projectdate3" placeholder="Project duration / Time period of project (eg. March 2015 - June 2016)" autocomplete="on" onfocus="selectprojectdate3()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="work_3" id="work3" placeholder="Project description" autocomplete="on" spellcheck="true" onfocus="selectwork3()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="url" name="worklink_3" id="worklink3" placeholder="Paste link of project (if available)" autocomplete="on" onfocus="selectworklink3()">
      </div>
     </div>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="project_4" id="project4" placeholder="Project name" autocomplete="on" onfocus="selectproject4()" onkeyup="hidew4()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="projectdate_4" id="projectdate4" placeholder="Project duration / Time period of project (eg. March 2015 - June 2016)" autocomplete="on" onfocus="selectprojectdate4()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="work_4" id="work4" placeholder="Project description" autocomplete="on" spellcheck="true" onfocus="selectwork4()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="url" name="worklink_4" id="worklink4" placeholder="Paste link of project (if available)" autocomplete="on" onfocus="selectworklink4()">
      </div>
     </div>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="project_5" id="project5" placeholder="Project name" autocomplete="on" onfocus="selectproject5()" onkeyup="hidew5()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="projectdate_5" id="projectdate5" placeholder="Project duration / Time period of project (eg. March 2015 - June 2016)" autocomplete="on" onfocus="selectprojectdate5()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="work_5" id="work5" placeholder="Project description" autocomplete="on" spellcheck="true" onfocus="selectwork5()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="url" name="worklink_5" id="worklink5" placeholder="Paste link of project (if available)" autocomplete="on" onfocus="selectworklink5()">
      </div>
     </div>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="project_6" id="project6" placeholder="Project name" autocomplete="on" onfocus="selectproject6()" onkeyup="hide6()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="projectdate_6" id="projectdate6" placeholder="Project duration / Time period of project (eg. March 2015 - June 2016)" autocomplete="on" onfocus="selectprojectdate6()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="work_6" id="work6" placeholder="Project description" autocomplete="on" spellcheck="true" onfocus="selectwork6()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="url" name="worklink_6" id="worklink6" placeholder="Paste link of project (if available)" autocomplete="on" onfocus="selectworklink6()">
      </div>
     </div>
     ...
     <div class="row">
      ...
      <div class="col-75">
       <input type="text" name="project_7" id="project7" placeholder="Project name" autocomplete="on" onfocus="selectproject7()" onkeyup="hide7()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="projectdate_7" id="projectdate7" placeholder="Project duration / Time period of project (eg. March 2015 - June 2016)" autocomplete="on" onfocus="selectprojectdate7()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="text" name="work_7" id="work7" placeholder="Project description" autocomplete="on" onfocus="selectwork7()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="url" name="worklink_7" id="worklink7" placeholder="Paste link of project (if available)" autocomplete="on" onfocus="selectworklink7()">
      </div>
     </div>
    </div>
   </div>
   ...
   <div class="container">
    ...
    <div class="row-12">
     <div class="row">
      ...
      <div class="col-75">
       <input type="url" name="linkedin" id="link_1" placeholder="eg. www.linkedin.com/username" autocomplete="on" onfocus="selectText1()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="url" name="twitter" id="link_2" placeholder="eg. www.twitter.com/username" autocomplete="on" onfocus="selectText2()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="url" name="facebook" id="link_3" placeholder="eg. www.facebook.com/username" autocomplete="on" onfocus="selectText3()">
      </div>
     </div>
     <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
       <input type="url" name="instagram" id="link_4" placeholder="eg. www.instagram.com/username" autocomplete="on" onfocus="selectText4()">
      </div>
     </div>
    </div>
   </div>

...
<html>
    <head>
        ...
        <title>Method Not Allowed | 405 ERROR</title>
        <meta charset="utf-8">
 ...
 <body style="background:#fffafe;" onoffline="lost()" ononline="load()" id="body">
  ...
  <div class="container w3-center">
   <img src="http://localhost:8084/ResumeCreta/images/405.gif" alt="page not found" style="width:40%;height:auto; margin-top:2%" draggable="false">
